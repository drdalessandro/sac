                      ...
                      <div className="px-4 py-6 sm:px-6">
                        <ul role="list" className="space-y-8">
                          {messages && profiles.length > 0 ? (
                                          ...
                                          {resource.payload.map((content, contentIndex) => (
                                            <React.Fragment key={contentIndex}>
                                              ...
                                              {content.contentAttachment?.url && (
                                                ...
                                                >
                                                  <DocumentArrowDownIcon className="mr-1 h-6 w-6 text-red-600 group-hover:text-red-700" />
                                                  Descargar adjunto
                                                </a>
                                              )}
                                            </React.Fragment>
                            ...
                            <p className="text-md text-center text-gray-700">Sin mensajes...</p>
                          )}
                        </ul>
                      </div>
                    </div>
                        ...
                        <div className="min-w-0 flex-1">
                          <div>
                            ...
                            <textarea
                              ...
                              name="comentarios"
                              rows={3}
                              className="block w-full resize-none rounded-md border border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"
                      ...
                      <div>
                        <UploadButton onUpload={(value: Attachment) => setAttachment(value)}>
                          <div className="group flex">
                            <div className="flex items-center rounded-l-md bg-red-600 px-2 group-hover:bg-red-700">
                              {attachment ? (
                            ...
                            <div className="inline-flex items-center justify-center whitespace-nowrap rounded-r-md border border-gray-200 bg-white px-4 py-2 text-gray-700 shadow-sm">
                              {attachment ? attachment.title : 'Seleccione archivo local'}
                            </div>
                          </div>
                        </UploadButton>
                      </div>
                      <Button marginsUtils="ml-0" label="Enviar" action={() => createResource(attachment)} />
                    </div>
                  </div>
                </section>
              </div>
