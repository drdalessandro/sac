  ...
  return (
    <>
      ...
      {practitioners.length > 0 ? (
        practitioners?.map(({ name, photo, address }, practitionerIndex) => {
          ...
          return (
            <div className="mb-20 last:mb-0" key={practitionerIndex}>
              <InfoSection title="Datos de Atención Primaria">
                <div className="mx-auto px-4 py-5 text-center sm:px-6">
                  ...
                  />
                  <Link
                    to="Seleccione un proveedor de atención primaria"
                  ...
                  >
                    Selecciones un proveedor de atención primaria
                  </Link>
                </div>
              </InfoSection>
              {address && (
        ...
        <InfoSection title="Mi proveedor de atención primaria">
          <div className="mx-auto px-4 py-5 text-center sm:px-6">
            <GeneralInfo
