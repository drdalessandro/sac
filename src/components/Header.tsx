...
const navigation = [
  { name: 'Datos', href: '/health-record' },
  { name: 'Laboratorio', href: '/laboratory' },
  { name: 'Comunicación', href: '/messages' },
  { name: 'Bienestar', href: '/care-plan' },
  { name: 'Seguimiento', href: '/get-care' },
];
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        <Popover className="flex h-20 justify-between">
          ...
          <div className="flex items-center lg:hidden">
            {/* Mobile menu button */}
            <Popover.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500">
