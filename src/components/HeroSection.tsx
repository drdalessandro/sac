...
import WorkingEnvironmentImage from '../img/landingPage/8_pasos_AHA_Cardio.jpg';
...
export function HeroSection(): JSX.Element {
  return (
    <div className="relative bg-gradient-radial from-red-50">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-white text-base font-normal hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Servicios</span>
                      <ChevronDownIcon
              ...
              <div className="space-y-6 py-6 px-5">
                ...
                <div>
                  <p className="mt-6 text-center text-base font-normal text-gray-500">
                    Ya tiene una cuenta?
                    <Link to="/signin" className="ml-6 text-red-600 hover:text-red-500">
                      Ingresar!
                    </Link>
                  <Link
                    to="/register"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-normal text-white shadow-sm hover:bg-red-700"
                  >
        ...
        <div className="flex w-full flex-col items-center pt-8 pb-8 text-left sm:items-start sm:pb-36 md:py-36">
          <div className="flex flex-col items-center sm:items-start">
            <h1 className="text-center text-3xl font-medium tracking-wider text-gray-900 sm:text-left sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              <p>PROGRAMA</p>
              <p className="text-red-600"> RESIDENTES</p>
            </h1>
            <p className="mt-6 w-full max-w-xs text-lg font-normal text-neutral-600 sm:max-w-none md:max-w-sm lg:max-w-lg lg:text-xl">
             Area de Docencia SAC ❤️{' '}
            </p>
	    <div className="mt-8 sm:flex sm:justify-center md:mt-20 lg:justify-start">
              <div className="rounded-md shadow">
                <a href="/signin" className="flex w-full items-center justify-center rounded-md border border-transparent bg-red-600 py-4 px-20 text-lg font-normal text-white hover:bg-red-700">Ingresar!</a>
              </div>
            </div>
          </div>
          <img
